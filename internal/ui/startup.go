	...
	return []ProviderGroup{
		...
		},
		{
			...
			Models: []ModelChoice{
				...
				{Name: "Gemini 3.1 Flash Lite (preview)", ID: "gemini-3.1-flash-lite-preview", ContextWindow: 1048576, MaxTokens: 65536},
				...
				{Name: "Gemini 2.0 Flash Lite", ID: "gemini-2.0-flash-lite", ContextWindow: 1000000, MaxTokens: 65536},
				{Name: "Custom model ID", ID: ""},
			},
		},
		{
