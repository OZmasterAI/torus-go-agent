...
## 14 hook points (exact list)

on_agent_start, on_agent_end, on_turn_start, on_turn_end, before_llm_call, after_llm_call, before_tool_call, after_tool_call, before_context_build, after_context_build, on_token_count, on_error, on_stop_failure, post_compact

Do NOT invent hook names. These are the only 14.
